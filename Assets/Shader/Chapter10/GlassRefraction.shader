...
Shader "Unity Shaders Book/Chapter 10/GlassRefraction"
{
    Properties
    {
        ...
        _RefractionAmount("Refrac Amount", Range(0.0, 1.0)) = 1.0
    }
    SubShader
    {
        Tags
        ...
        Pass
        {
            ...
            fixed4 frag(v2f i) : SV_TARGET
            {
                ...
                fixed3 wolrdViewDir = normalize(UnityWorldSpaceViewDir(worldPos));
                ...
                fixed3 reflDir = reflect(-wolrdViewDir, bump);
